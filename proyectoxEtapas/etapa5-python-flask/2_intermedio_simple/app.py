...
from db.gestiondb import obtener_todos_protocolos, agregar_protocolo, eliminar_protocolo
...
def protocolos():
    ...
    if request.method == 'POST':
        ...
        if nombre and acronimo and nombreCapa and descripcion:
            ...
            if agregar_protocolo(nombre, acronimo, nombreCapa, descripcion):
                # Si se agregó exitosamente, mostrar mensaje de éxito
    ...
    protocolos_lista = obtener_todos_protocolos()
